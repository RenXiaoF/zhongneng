...
@Component({
  selector: 'app-fuli-area',
  templateUrl: './fuli-area.page.html',
  styleUrls: ['./fuli-area.page.scss'],
})
export class FuliAreaPage implements OnInit {

  public product_type = '3'; // 商品的类型，0：全部商品，1：boss批发区商品，2：零元区商品，3：福利区商品，4：易货区商品
  public page = 1;           // 分页
